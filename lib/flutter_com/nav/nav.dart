...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : AHomepageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'bRegister',
          path: '/bRegister',
          builder: (context, params) => BRegisterWidget(),
        ),
        FFRoute(
          name: 'eTasksList',
          path: '/eTasksList',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'eTasksList')
              : NavBarPage(
                  initialPage: 'eTasksList',
                  page: ETasksListWidget(
                    toDoList: params.getParam('toDoList', ParamType.String),
        ...
        FFRoute(
          ...
          builder: (context, params) => GProfileWidget(
        ...
        FFRoute(
          ...
          path: '/fMyProfile',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'fMyProfile')
              : FMyProfileWidget(),
        ),
        FFRoute(
          name: 'hChangePassword',
          path: '/hChangePassword',
          builder: (context, params) => HChangePasswordWidget(),
        ),
        FFRoute(
          name: 'iSuccessCreateAccount',
          path: '/iSuccessCreateAccount',
          builder: (context, params) => ISuccessCreateAccountWidget(),
        ),
        FFRoute(
          name: 'jPendingTask',
          path: '/jPendingTask',
          builder: (context, params) => JPendingTaskWidget(
            toDoList: params.getParam('toDoList', ParamType.String),
            to: params.getParam('to', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'kCompletedTask',
          path: '/kCompletedTask',
          builder: (context, params) => KCompletedTaskWidget(
            toDoList: params.getParam('toDoList', ParamType.String),
            to: params.getParam('to', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'lMissedTask',
          path: '/lMissedTask',
          builder: (context, params) => LMissedTaskWidget(
            toDoList: params.getParam('toDoList', ParamType.String),
            to: params.getParam('to', ParamType.String),
          ),
        ),
        ...
        FFRoute(
          name: 'ourValues',
          path: '/ourValues',
          builder: (context, params) => OurValuesWidget(),
        ),
        FFRoute(
