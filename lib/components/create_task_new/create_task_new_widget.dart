                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'bbj8lcj8' /* Fill out the details below to ... */,
                                ),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            onFieldSubmitted: (_) async {
                              setState(() {
                                _model.textController1?.text = 'task';
                              });
                            },
                            autofocus: true,
                            obscureText: false,
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            onFieldSubmitted: (_) async {
                              setState(() {
                                _model.textController2?.text = 'details';
                              });
                            },
                            obscureText: false,
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                '50r4ucnv' /* Enter a description here... */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await ToDoListRecord.collection.doc().set({
