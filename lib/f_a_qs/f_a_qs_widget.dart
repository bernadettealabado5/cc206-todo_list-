        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'vebiymi4' /* Frequently Asked Questions */,
            ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    GradientText(
                                      FFLocalizations.of(context).getText(
                                        'jqrftg39' /* Q1: What is Get Stuff Done? */,
                                      ),
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'eshpvn3p' /* A: Get Stuff Done is a user-fr... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                            ...
                            children: [
                              ListView(
                                ...
                                children: [
                                  GradientText(
                                    FFLocalizations.of(context).getText(
                                      '928whj0x' /* Q2: How do I sign up and is my... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'um4taaxa' /* A: Signing up is easy! Use our... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                            ...
                            children: [
                              ListView(
                                ...
                                children: [
                                  GradientText(
                                    FFLocalizations.of(context).getText(
                                      'nyzlv34i' /* Q3: Can I collaborate with oth... */,
                                    ),
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '9eq5h5k7' /* A: Currently, Get Stuff Done i... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                            ...
                            children: [
                              ListView(
                                ...
                                children: [
                                  GradientText(
                                    FFLocalizations.of(context).getText(
                                      '0bm63vuk' /* Q4: Does Get Stuff Done suppor... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '11ulixfd' /* A: Currently, Get Stuff Done d... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                            ...
                            children: [
                              ListView(
                                ...
                                children: [
                                  GradientText(
                                    FFLocalizations.of(context).getText(
                                      'bvup3n7p' /* Q5: Can I customize the appear... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'k8qgzve2' /* A: Currently, the app has a de... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
