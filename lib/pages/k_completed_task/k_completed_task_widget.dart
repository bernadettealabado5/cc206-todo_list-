...
import 'k_completed_task_model.dart';
export 'k_completed_task_model.dart';

class KCompletedTaskWidget extends StatefulWidget {
  const KCompletedTaskWidget({
    Key? key,
    this.toDoList,
    this.to,
  }) : super(key: key);
  ...
  @override
  _KCompletedTaskWidgetState createState() => _KCompletedTaskWidgetState();
}

class _KCompletedTaskWidgetState extends State<KCompletedTaskWidget>
    with TickerProviderStateMixin {
  late KCompletedTaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KCompletedTaskModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ToDoListRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ToDoListRecord> kCompletedTaskToDoListRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
