...
import 'j_pending_task_model.dart';
export 'j_pending_task_model.dart';

class JPendingTaskWidget extends StatefulWidget {
  const JPendingTaskWidget({
    Key? key,
    this.toDoList,
    this.to,
  }) : super(key: key);
  ...
  @override
  _JPendingTaskWidgetState createState() => _JPendingTaskWidgetState();
}

class _JPendingTaskWidgetState extends State<JPendingTaskWidget>
    with TickerProviderStateMixin {
  late JPendingTaskModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JPendingTaskModel());
    ...
    return StreamBuilder<List<ToDoListRecord>>(
      stream: queryToDoListRecord(
        queryBuilder: (toDoListRecord) => toDoListRecord
            ...
            .where(
              'toDoDate',
              isLessThanOrEqualTo: _model.datePicked1,
            )
            .orderBy('toDoDate'),
      ),
      builder: (context, snapshot) {
        ...
        List<ToDoListRecord> jPendingTaskToDoListRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
