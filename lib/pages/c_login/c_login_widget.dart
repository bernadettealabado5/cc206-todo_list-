...
class CLoginWidget extends StatefulWidget {
  const CLoginWidget({Key? key}) : super(key: key);

  @override
  _CLoginWidgetState createState() => _CLoginWidgetState();
}
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText:
                                        ...
                                        'yct0ec9w' /* Email Address */,
                                      ),
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'od0aapcq' /* Enter your email here... */,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'q74supk4' /* Enter your password here... */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            context
                                                .pushNamed('hChangePassword');
                                          },
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'r7uakjty' /* Forgot Password? */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
